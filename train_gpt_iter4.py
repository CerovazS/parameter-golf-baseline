...
def main() -> None:
    ...
    args = Hyperparameters()
    # Iter-4: re-add torch.compile on zeropower_via_newtonschulz5 even with Triton kernels.
    # Hypothesis: compile creates graph breaks at each Triton call but may still help.
    # Empirical test to determine whether compile + Triton is faster, slower, or crashes.
