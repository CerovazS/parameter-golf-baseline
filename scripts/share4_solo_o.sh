...
#SBATCH --job-name=pgolf-share4-solo-o
...
srun uv run bash ./tools/launch_run.sh \
    ...
    --gpus 4 \
    --run-id "$RUN_ID" \
    --hypothesis "4xA100 700s | SharedC solo O rank_o=256 pair=(0,4)"
