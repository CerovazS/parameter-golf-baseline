...
"""
# train_gpt_exp.py — Experimental: Gram-Newton-Schulz Muon (arxiv 2505.16932)
# Replaces zeropower_via_newtonschulz5 with gram_newton_schulz.
# See plan.md for full change description.
