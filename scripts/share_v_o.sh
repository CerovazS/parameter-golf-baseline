...
#SBATCH --job-name=pgolf-share-v-o
...
export HYPOTHESIS="SharedC V+O rank_v=128 rank_o=256: configurazione principale"
export RUN_ID="share_v_o_$(date +%Y%m%d)_job${SLURM_JOB_ID:-local}"
